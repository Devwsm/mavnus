<footer class="flex flex-col w-full h-full text-white bg-[#5E0006]">
    ...
    <div class="border-b border-white/10 px-6 py-6">
        <ul
            ...
            <li><a href="{{ route('home') }}#returns" class="hover:opacity-70 transition">Returns &amp; Exchanges</a></li>
            <li><a href="{{ route('home') }}#contact" class="hover:opacity-70 transition">Contact Support</a></li>
            <li><a href="{{ route('home') }}#terms" class="hover:opacity-70 transition">Terms &amp; Conditions</a></li>
    ...
    <!-- ===================== Newsletter + Region ===================== -->
    <div class="px-6 py-10 grid grid-cols-1 lg:grid-cols-2 gap-10 border-b border-white/10">
        <!-- Newsletter -->
        ...
        <div class="max-w-xs mx-auto lg:mx-0 lg:ml-auto text-center lg:text-left w-full">
            ...
            <div class="relative">
                ...
                <i class="bi bi-chevron-down absolute right-4 top-1/2 -translate-y-1/2 text-sm pointer-events-none"></i>
            </div>
        </div>
    </div>

    <!-- ===================== Social + Copyright ===================== -->
    <div class="px-6 py-6 flex flex-col-reverse lg:flex-row items-center justify-between gap-4 text-xs text-white/70">
