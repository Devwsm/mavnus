    ...
    <div class="">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div class="flex flex-col gap-4">
                <!-- Main image -->
                <div class="relative w-full aspect-square bg-gray-100 overflow-hidden rounded-lg">
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <button onclick="selectSize('S')"
                            class="size-btn px-4 py-2 border border-gray-300 bg-white text-gray-900 rounded-lg text-sm hover:border-gray-500">
                            S
                        </button>
                        <button onclick="selectSize('M')"
                            class="size-btn px-4 py-2 border border-black bg-black text-white rounded-lg text-sm">
                            M
                        </button>
                        <button onclick="selectSize('L')"
                            class="size-btn px-4 py-2 border border-gray-300 bg-white text-gray-900 rounded-lg text-sm opacity-50 cursor-not-allowed disabled"
                            disabled>
                            L
                        </button>
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="flex items-center justify-center w-fit border rounded-lg">
                    ...
                    <button class="px-6 py-2 bg-black text-white text-sm font-medium rounded-lg hover:bg-gray-800">
                        Add to Cart
                    </button>
                </div>
