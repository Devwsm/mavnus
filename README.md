...
- Riwayat & status pesanan customer (kalau login)
...
Sudah dicek: semua controller, method, komponen Blade, halaman, middleware, service, dan model di atas **masih dipakai** — gak ada file/fungsi mati yang perlu dihapus. Sisa referensi ke "album" cuma ada di riwayat migration (`albums_migration.php`, `remove_album_category_and_add_stock.php`), itu memang riwayat perubahan skema, bukan kode aktif — aman dibiarkan.
