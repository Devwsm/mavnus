...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('order_items', function (Blueprint $table) {
            ...
            $table->foreignId('product_id')->nullable()->constrained('products', 'id_product')->nullOnDelete();
            $table->foreignId('variant_id')->nullable()->constrained('product_variants', 'id_variant')->nullOnDelete();
